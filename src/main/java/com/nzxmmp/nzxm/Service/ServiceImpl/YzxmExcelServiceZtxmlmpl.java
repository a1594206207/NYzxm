 ...
 *
 */
@Service("YzxmExcelServiceZtxmlmpl")
public class YzxmExcelServiceZtxmlmpl implements ExcelServic {
    ...
    public Workbook outTemplate() {
        ClassPathResource classPathResource = new ClassPathResource("ExcxelTemplate/外资在谈项目模板.xlsx");
